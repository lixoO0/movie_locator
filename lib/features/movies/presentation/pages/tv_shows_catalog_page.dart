...
import '../widgets/tv_show_list.dart';
import '../widgets/loading_widget.dart';
import '../widgets/error_widget.dart' as custom;
import '../../../../shared/theme/theme_bloc.dart';

class TvShowsCatalogPage extends StatefulWidget {
  const TvShowsCatalogPage({super.key});

  @override
  State<TvShowsCatalogPage> createState() => _TvShowsCatalogPageState();
}

class _TvShowsCatalogPageState extends State<TvShowsCatalogPage> {
  int? selectedGenreId;
  int? selectedYear;
  double? minRating;
  ...
  void initState() {
    ...
    context.read<MoviesBloc>().add(const GetPopularTvShowsEvent());
  }
  
  void _applyFilters() {
    context.read<MoviesBloc>().add(DiscoverTvShowsEvent(
            ...
            child: BlocBuilder<MoviesBloc, MoviesState>(
              builder: (context, state) {
                if (state is MoviesLoading) {
                  ...
                  final canLoadMore = !state.hasReachedMax && state.tvShows.isNotEmpty;
                  return TvShowList(
                ...
                return const Center(child: Text('Немає серіалів'));
              },
            ),
          ),
        ],
